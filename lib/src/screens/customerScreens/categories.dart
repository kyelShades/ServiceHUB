...
import 'package:servicehub/src/screens/customerScreens/home_screen.dart'; // Import HomeScreen for navigation
...
class _CategoriesScreenState extends State<CategoriesScreen> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: _onWillPop, // Attach the custom back navigation logic
      child: Scaffold(
